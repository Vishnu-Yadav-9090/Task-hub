...
!(function (t) {
    ...
    function v(t, e, n) {
        if (!e) return !0;
        n.xSteps[t] =
            d([n.xVal[t], n.xVal[t + 1]], e) / f(n.xPct[t], n.xPct[t + 1]);
    }
    function b(t, e, n, r) {
        (this.xPct = []),
            (this.xVal = []),
    ...
    (b.prototype.getMargin = function (t) {
        ...
        (b.prototype.fromStepping = function (t) {
            return (
                ...
                (n = Math.pow(10, 7)),
                Number((Math.round(e * n) / n).toFixed(7))
            );
            var e, n;
        }),
        (b.prototype.getStep = function (t) {
            return (
                this.direction && (t = 100 - t),
                (t = m(this.xPct, this.xSteps, this.snap, t)),
                this.direction && (t = 100 - t),
                t
            );
        }),
    ...
    function S(t, e) {
        if (((e = i(e)), !Array.isArray(e) || !e.length || e.length > 2))
    ...
    function O(t, n) {
        ...
        if (((t.limit = t.spectrum.getMargin(n)), !t.limit))
            throw new Error(
    ...
    function k(t, e) {
        ...
        if (!1 !== e)
            if (!0 === e)
                for (t.tooltips = [], n = 0; n < t.handles; n++)
                    t.tooltips.push(!0);
            else {
                if (((t.tooltips = i(e)), t.tooltips.length !== t.handles))
                    throw new Error(
    ...
    function C(t) {
        var e,
            n = { margin: 0, limit: 0, animate: !0, format: w };
        e = {
            step: { r: !1, t: x },
            start: { r: !0, t: S },
            connect: { r: !0, t: M },
    ...
    function V(e, f) {
            ...
            var e = t.mode,
                ...
                i = (function (t, e, n) {
                    ...
                    return "positions" === t
                        ...
                        ? n
                            ? e.map(function (t) {
                                  return b.fromStepping(
                                      b.getStep(b.toStepping(t))
                                  );
                              })
                            : e
                        : void 0;
                        ...
                        n.forEach(function (r, i) {
                            ...
                            if (
                                ...
                                for (
                                    ...
                                    for (
                                        m = (p = (d = b.toStepping(s)) - l) / t,
                                            v = p / (g = Math.round(m)),
                                            f = 1;
                                        f <= g;
                                        f += 1
                                    )
                                        o[(l + f * v).toFixed(5)] = ["x", 0];
                                    (h =
                                        n.indexOf(s) > -1
                                            ? 1
                                            : "steps" === e
        ...
        function P(t, e, n) {
            void 0 !== e && 1 !== f.handles && (e = Math.abs(e - f.dir)),
                    ...
                    t === o &&
                        x[r].forEach(function (t) {
                            t.call(
                                ...
                                i(B()),
                                e,
                                i(O(Array.prototype.slice.call(w))),
                                n || !1,
                                v
                            );
                        });
        ...
        function k(t, e) {
            ...
            i.noUiListeners.forEach(function (t) {
                ...
                P("set", r),
                P("change", r),
                void 0 !== e.handleNumber && P("end", e.handleNumber);
        }
        function A(t, e) {
            "mouseout" === t.type &&
        ...
        function F(t, e) {
            ...
            if (((n.noUiListeners = r.concat(i, a)), t.cursor)) {
                ...
                (document.body.noUiListener = s),
                    document.body.addEventListener("selectstart", s, !1);
            }
        ...
        function V(e) {
            ...
            if (
                ...
                (r = o < a / 2 || 1 === p.length ? 0 : 1),
                p[r].hasAttribute("disabled") && (r = r ? 0 : 1),
                (i = (100 * (o -= t(d)[f.style])) / U()),
                f.events.snap || n(g, y[14], 300),
                p[r].hasAttribute("disabled"))
            )
                return !1;
            q(p[r], i),
                P("slide", r, !0),
        ...
        function q(t, e, n) {
            var i = t !== p[0] ? 1 : 0,
                ...
                l = v[1] - f.limit;
            return (
                p.length > 1 && (e = i ? Math.max(e, s) : Math.min(e, u)),
                !1 !== n &&
                    f.limit &&
                    p.length > 1 &&
                    (e = i ? Math.min(e, c) : Math.max(e, l)),
                (e = b.getStep(e)),
                (e = r(parseFloat(e.toFixed(7)))) !== v[i] &&
                    (window.requestAnimationFrame
                        ? window.requestAnimationFrame(function () {
                              t.style[f.style] = e + "%";
                          })
                        : (t.style[f.style] = e + "%"),
                    t.previousSibling || (a(t, y[17]), e > 50 && o(t, y[17])),
                    (v[i] = e),
                    (w[i] = b.fromStepping(e)),
                    P("update", i),
                    !0)
            );
        }
        function z(t) {
            var e,
                ...
                o = i(t);
            for (
                f.dir && f.handles > 1 && o.reverse(),
                    f.animate && -1 !== v[0] && n(g, y[14], 300),
                    e = p.length > 1 ? 3 : 1,
                    1 === o.length && (e = 1),
                    (function (t, e) {
                        var n, r, i;
                        for (f.limit && (t += 1), n = 0; n < t; n += 1)
                            null !== (i = e[(r = n % 2)]) &&
                                !1 !== i &&
        ...
        return (
            ...
            f.tooltips &&
                (function () {
                    ...
                    var t = p.map(E);
                    f.dir && (t.reverse(), f.tooltips.reverse()),
                        D("update", function (e, n, r) {
                            t[n] &&
                                (t[n].innerHTML =
                                    !0 === f.tooltips[n]
                                        ? e[n]
            ...
            (h = {
                ...
                updateOptions: function (t) {
                    ...
                    for (
                        ["margin", "limit", "step", "range", "animate"].forEach(
                            function (e) {
                                void 0 !== t[e] && (f[e] = t[e]);
                            }
                        ),
                            r.spectrum.direction = b.direction,
                            b = r.spectrum,
                            v = [-1, -1],
                            z(n),
                            e = 0;
            ...
            (function (t) {
                ...
                if (!t.fixed)
                    for (e = 0; e < p.length; e += 1)
                        L(c.start, p[e].children[0], F, {
                            handles: [p[e]],
                            handleNumber: e,
                        });
                if ((t.tap && L(c.start, d, V, { handles: p }), t.hover))
                    for (
                        L(c.move, d, T, { hover: !0 }), e = 0;
                        e < p.length;
                        e += 1
                    )
                ...
                t.drag &&
                    (o((n = [d.querySelector("." + y[7])])[0], y[10]),
                    t.fixed && n.push(p[n[0] === p[0] ? 1 : 0].children[0]),
                    n.forEach(function (t) {
                        L(c.start, t, F, { handles: p });
                    }));
            })(f.events),
            h
        );
    ...
    (function () {
        ...
        function o(t, n, r, o, a, s, u, c, l, f, d, p) {
            ...
            return (
                s && (p = s(p)),
                !!i(p) &&
                    (!1 !== t && 0 === parseFloat(p.toFixed(t)) && (p = 0),
                    p < 0 && ((h = !0), (p = Math.abs(p))),
                    !1 !== t &&
                        (p = (function (t, e) {
                            var n = Math.pow(10, e);
                    ...
                    -1 !== (p = p.toString()).indexOf(".")
                        ? ((g = (m = p.split("."))[0]), r && (b = r + m[1]))
                        : (g = p),
                    n && ((g = e(g).match(/.{1,3}/g)), (g = e(g.join(e(n))))),
                    h && c && (w += c),
                    o && (w += o),
                    h && l && (w += l),
                    (w += g),
        ...
        function a(t, e, r, o, a, s, u, c, l, f, d, p) {
            ...
            return (
                d && (p = d(p)),
                !(!p || "string" != typeof p) &&
                    (c && n(p, c) && ((p = p.replace(c, "")), (h = !0)),
                    o && n(p, o) && (p = p.replace(o, "")),
                    l && n(p, l) && ((p = p.replace(l, "")), (h = !0)),
                    a &&
                        (function (t, e) {
                            return t.slice(-1 * e.length) === e;
                        })(p, a) &&
                        (p = p.slice(0, -1 * a.length)),
                    e && (p = p.split(e).join("")),
                    r && (p = p.replace(r, ".")),
                    h && (m += "-"),
                    "" !== (m = (m += p).replace(/[^0-9\.\-.]/g, "")) &&
                        ((m = Number(m)), u && (m = u(m)), !!i(m) && m))
            );
        }
        function s(e, n, r) {
            var i,
