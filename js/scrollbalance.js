        ...
        initialize: function () {
         ...
         is resized. */
            ...
            this.columns.each(function (i) {
                ...
                // column
                columnData.enabled =
                    that.containerHeight - columnData.height >
                ...
                columnData.minFixTop = Math.min(
                    0,
                    that.winHeight - columnData.height
                );
            ...
            if (
                ...
                if (state === "disabled") {
                    ...
                    inner.css({
                        ...
                        top:
                            (state === "bottom"
                                ? this.containerHeight - columnData.height
                                : 0) + "px",
                        left: 0,
                    });
                }
