                            ...
                            <div className="d-lg-flex align-items-lg-center">
                              ...
                              <div className="details ml15 ml0-md mb15-md">
                                <h5 className="title mb-2">
                                  Marketing and Communications Manager Position:
                                  Exciting
                                </h5>
                                <h6 className="mb-0 text-thm">Mailchimp</h6>
                              </div>
                            </div>
                          </div>
                        </th>
                        <td className="vam">
                          <span className="fz15 fw400">3+ Applied</span>
                        </td>
                        <td className="vam">
                          <span>October 27, 2019</span>
                          <br />
                          <span className="fz14 fw400">April 25, 2015</span>
                        </td>
                        <td className="vam">
...
export default Dash_Manage_Jobs