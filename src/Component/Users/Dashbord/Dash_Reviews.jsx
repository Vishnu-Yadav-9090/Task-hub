                      ...
                      >
                          ...
                          <div className="bdrb1 pb20">
                            <div className="mbp_first position-relative d-sm-flex align-items-center justify-content-start mb30-sm mt30">
                              ...
                              <div className="ml20 ml0-xs mt20-xs">
                                ...
                                <h6 className="mt-0 mb-1">Angelica Pan</h6>
                            ...
                            <p className="text mt20 mb20">
                              Excellent delivery as usual. We didn't need to do
                              any reviews because the seller understood the
                              briefing very well and delivered design exactly to
                              our needs. Excellent delivery as usual. We didn't
                              need to do any reviews because the seller
                              understood the briefing very well and delivered
                              design exactly to our needs.
                            </p>
                            <a
                        ...
                        <div className="col-md-12">
                          ...
                          <p className="text mt20 mb20">
                            ...
                            briefing very well and delivered design exactly to
                            our needs.Excellent delivery as usual. We didn't
                            need to do any reviews because the seller understood
                            the briefing very well and delivered design exactly
                            to our needs.Excellent delivery as usual. We didn't
                            need to do any reviews because the seller understood
                            the briefing very well and delivered.
                          </p>
                          <a
                            href="page-service-single.html"
                            className="ud-btn bgc-thm4 text-thm"
