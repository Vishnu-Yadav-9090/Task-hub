...
const Dashbord = () => {
              ...
              <div className="d-flex align-items-center justify-content-between statistics_funfact">
                <div className="details">
                  ...
                  <div className="text fz14">
                    <span className="text-thm">15</span> New Offered
                  </div>
                </div>
            ...
            <div className="col-sm-6 col-xxl-3">
              <div className="d-flex align-items-center justify-content-between statistics_funfact">
                <div className="details">
                  ...
                  <div className="title">1792</div>
                  <div className="text fz14">
                    <span className="text-thm">90+</span> New Completed
                  </div>
                </div>
                <div className="icon text-center">
            ...
            <div className="col-sm-6 col-xxl-3">
              <div className="d-flex align-items-center justify-content-between statistics_funfact">
                <div className="details">
                  ...
                  <div className="text fz14">
                    <span className="text-thm">75+</span> New Queue
                  </div>
                </div>
                <div className="icon text-center">
            ...
            <div className="col-sm-6 col-xxl-3">
              <div className="d-flex align-items-center justify-content-between statistics_funfact">
                <div className="details">
                  ...
                  <div className="title">28,786</div>
                  <div className="text fz14">
                    <span className="text-thm">299+</span> New Review
                  </div>
                </div>
                <div className="icon text-center">
              ...
              <div className="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                <div className="navtab-style1">
                  ...
                  <div className="d-sm-flex align-items-center justify-content-between">
                    <h4 className="title fz17 mb20">Profile Traffic</h4>
                  ...
                  <canvas
                    id="myChartweave"
                    style={{ height: 306, display: "block", width: 613 }}
                    width={613}
                    height={306}
            ...
            <div className="col-xl-4">
              <div className="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                ...
                <canvas
                  ...
                  height={228}
                  width={264}
                  style={{ display: "block", width: 264, height: 228 }}
                  className="chartjs-render-monitor"
                />
              </div>
            </div>
                ...
                <div className="dashboard-img-service">
                  ...
                  <div className="listing-style1 list-style d-block d-xl-flex align-items-center border-0 mb-0">
                    ...
                    <div className="list-content flex-grow-1 pt0 pb-0 pl15 pl0-lg pe-0">
                      <h6 className="list-title mb-2">
                        <a href="page-service-single.html">
                          I will do clean modern minimalist business logo design
                        </a>
                      </h6>
                      <div className="list-meta d-flex justify-content-between align-items-center">
                        <div className="review-meta d-flex align-items-center">
                ...
                <div className="dashboard-img-service">
                  <div className="listing-style1 list-style d-block d-xl-flex align-items-start border-0 mb10">
                    ...
                    <div className="list-content flex-grow-1 py-0 pb10 pl15 pl0-lg">
                      <h6 className="list-title mb-2">
                        Medium. <span className="text-thm">has purchased</span>{" "}
                      ...
                      <div className="list-meta d-flex justify-content-between align-items-center">
                        ...
                        <div className="budget">
                          <p className="mb-0">
                            <span className="fz15 fw500 dark-color">$799</span>
                          </p>
                        </div>
                      </div>
                    </div>
  ...
  <a className="scrollToHome show" href="#">
