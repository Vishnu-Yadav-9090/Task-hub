        ...
        <div className="row align-items-center justify-content-between">
          <div className="col-auto pe-0">
            <div className="d-flex align-items-center">
              <a className="header-logo bdrr1 pr30 pr5-xl" href="index.html">
                ...
                <div className="list-meta d-sm-flex align-items-center mt30">
                  ...
                  <div className="ml20 ml0-xs">
                    ...
                    <p className="mb-0 dark-color fz15 fw500 list-inline-item ml15 mb5-sm ml0-xs">
                      <i className="flaticon-place vam fz20 me-2" /> Newyork,
                      USA
                    </p>
                    <p className="mb-0 dark-color fz15 fw500 list-inline-item ml15 mb5-sm ml0-xs">
          ...
          <div className="col-lg-8">
            ...
            <div className="service-about">
              ...
              <p className="text mb30">
                Readable when looking at its layout. content of a page when
                looking at its layout. The point of using Lorem Ipsum is that it
                has a more-or-less normal distribution of letters, as opposed to
                using 'Content here, content here', content of a page when
                looking at its layout. The point of using Lorem Ipsum is thatsed
              ...
              <p className="text mb30">
                ...
                still in their infancy. Readable when looking at its layout.
                content of a page when looking at its layout. The point of using
                Lorem Ipsum is that it has a more-or-less normal distribution of
                letters, as opposed to using 'ontent.
              </p>
              ...
              <div className="educational-quality">
                ...
                <div className="wrapper mb60">
                  ...
                  <p>
                    Looking at its layout. content of a page when looking at its
              ...
              <div className="educational-quality">
                ...
                <div className="wrapper mb60">
                  ...
                  <p>
                    When looking at its layout. content of a page when at its
                    layout. The point of using Lorem Ipsum is that it has a
                    more-or-less normal distribution of letters, as opposed to
                    using 'Content here, content here', making it look like
                    readable.
                        ...
                        <div className="owl-stage-outer">
                          ...
                          >
                            <div
                              ...
                              style={{ width: "227.328px", marginRight: 30 }}
                            >
                ...
                <div className="col-sm-6 col-xl-4">
                  <div className="listing-style1">
                    ...
                    <div className="list-content">
                      ...
                      <h6 className="list-title line-clamp2">
                        <a href="page-service-single.html">
                          I will build a fully responsive design in HTML,CSS,
              ...
              <hr className="opacity-100 mb60" />
              <div className="product_single_content mb60">
                  ...
                  <div className="row">
                      ...
                      <div className="d-md-flex align-items-center mb30">
                        <div className="total-review-box d-flex align-items-center text-center mb30-sm">
                          <div className="wrapper mx-auto">
                            <div className="t-review mb15">4.95</div>
                            <h5>Exceptional</h5>
                    ...
                    <div className="col-md-12">
                      ...
                      <p className="text mt20 mb20">
                        Readable when looking at its layout. content of a page
                        when looking at its layout. The point of using Lorem
                        Ipsum is that it has a more-or-less normal distribution
                        of letters, as opposed to using 'Content here, content
                        here', making it look like readable. Readable when
                        looking at its layout. content of a page when looking at
...
export default Freelancer_single