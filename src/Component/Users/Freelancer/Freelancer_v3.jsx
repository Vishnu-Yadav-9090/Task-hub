                      ...
                      <div className="details ml15 ml0-md mb15-md">
                        ...
                        <div className="review">
                          <p>
                            ...
                            <span className="dark-color fw500">4.9</span> (495
                            reviews)
                          </p>
                        </div>
                ...
                <div className="freelancer-style1 bdr1 hover-box-shadow row ms-0">
                  <div className="col-lg-8 ps-0">
                    <div className="d-lg-flex bdrr1 bdrn-lg">
                      ...
                      <div className="details ml15 ml0-md mb15-md">
                        <h5 className="title mb-1">Guy Hawkins</h5>
                        <p className="mb-0">UI/UX Designer</p>
                        <div className="review">
                          <p>
                            <i className="fas fa-star fz10 review-color pr10" />
                ...
                <div className="freelancer-style1 bdr1 hover-box-shadow row ms-0">
                  <div className="col-lg-8 ps-0">
                    <div className="d-lg-flex bdrr1 bdrn-lg">
                      ...
                      <div className="details ml15 ml0-md mb15-md">
                        <h5 className="title mb-1">David Daniel</h5>
                        <p className="mb-0">UI/UX Designer</p>
                        <div className="review">
                          <p>
                            <i className="fas fa-star fz10 review-color pr10" />
                ...
                <div className="freelancer-style1 bdr1 hover-box-shadow row ms-0">
                  <div className="col-lg-8 ps-0">
                    <div className="d-lg-flex bdrr1 bdrn-lg">
                      ...
                      <div className="details ml15 ml0-md mb15-md">
                        <h5 className="title mb-1">Darlene Robertson</h5>
                        <p className="mb-0">UI/UX Designer</p>
                        <div className="review">
                          <p>
                            <i className="fas fa-star fz10 review-color pr10" />
