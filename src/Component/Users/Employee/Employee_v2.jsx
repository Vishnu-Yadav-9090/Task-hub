...
const Employee_v2 = () => {
  ...
  <div className="body_content">
    ...
    <section className="breadcumb-section pt-0">
      <div className="cta-employee-single cta-banner mx-auto maxw1700 pt120 pb120 bdrs16 position-relative d-flex align-items-center mx20-lg px30-lg">
        <img
              ...
              <div className="col-sm-6 col-xl-4">
                <div className="job-list-style1 bdr1 pb10">
                  <div className="icon d-flex align-items-center mb20">
                    ...
                    <h6 className="mb-0 ml20">Mailchimp</h6>
                  ...
                  <div className="details">
                    ...
                    <p className="list-inline-item mb-3">Newyork, USA</p>
              ...
              <div className="col-sm-6 col-xl-4">
                <div className="job-list-style1 bdr1 pb10">
                  <div className="icon d-flex align-items-center mb20">
                    ...
                    <h6 className="mb-0 ml20">Dropbox</h6>
                    <span className="fav-icon flaticon-star" />
                  </div>
                  <div className="details">
                    <p className="">
              ...
              <div className="col-sm-6 col-xl-4">
                <div className="job-list-style1 bdr1 pb10">
                  <div className="icon d-flex align-items-center mb20">
                    ...
                    <h6 className="mb-0 ml20">Medium</h6>
                    <span className="fav-icon flaticon-star" />
                  </div>
                  <div className="details">
                    <p className="">
              ...
              <div className="col-sm-6 col-xl-4">
                <div className="job-list-style1 bdr1 pb10">
                  <div className="icon d-flex align-items-center mb20">
                    ...
                    <h6 className="mb-0 ml20">Invision</h6>
                    <span className="fav-icon flaticon-star" />
                  </div>
                  <div className="details">
                    <p className="">
