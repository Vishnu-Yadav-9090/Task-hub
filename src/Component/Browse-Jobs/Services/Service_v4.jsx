          ...
          >
            <div className="col-xl-5">
              <div className="position-relative">
                <h2 className="text-white">Creative &amp; Design </h2>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <h6 className="mb-0 text-white">How Taskhub Works</h6>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-9">
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="listing-style1 listi-style2 d-block d-xl-flex align-items-center">
                  ...
                  <div className="list-content flex-grow-1 ms-1">
                    ...
                    <h5 className="list-title mb-2">
                      <a href="page-service-single.html">
                        I will convert figma to HTML CSS using bootstrap
                      </a>
                    </h5>
                    <p className="list-text body-color fz15 mb-1">
                      I can assist you in designing clean and minimal UI UX for
                      your website in Adobe XD or <br /> Figma.
                    </p>
