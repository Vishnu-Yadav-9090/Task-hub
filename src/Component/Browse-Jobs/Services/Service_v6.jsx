  ...
  <section className="pt30 pb90 service-blog-thumb-size">
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-12">
          <div className="service-v5-slider slider-dib-sm navi_pagi_top_right slider-5-grid owl-carousel owl-theme mb30 owl-loaded owl-drag">
