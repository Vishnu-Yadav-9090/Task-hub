            ...
            <div className="col-sm-6 col-xl-4">
              <div className="job-list-style1 bdr1">
                ...
                <div className="details">
                  <h5 className="mb20">
                    Experienced Senior B2B Sales Consultant Opportunity
                  </h5>
                  <p className="list-inline-item mb-3">$120k-$145k Hourly</p>
              ...
              <div className="job-list-style1 bdr1">
                ...
                <div className="details">
                  <h5 className="mb20">
                    ...
                    <br className="d-none d-md-block" /> assistant
                  </h5>
                  <p className="list-inline-item mb-3">$120k-$145k Hourly</p>
                  <p className="list-inline-item mb-3 bdrl1 pl15">2-7 Days</p>
                  <p className="list-inline-item mb-0 bdrl1 pl15">Expensive</p>
              ...
              <div className="job-list-style1 bdr1">
                ...
                <div className="details">
                  <h5 className="mb20">
                    ...
                    <br className="d-none d-md-block" /> Manager
                  </h5>
                  <p className="list-inline-item mb-3">$120k-$145k Hourly</p>
                  <p className="list-inline-item mb-3 bdrl1 pl15">2-7 Days</p>
                  <p className="list-inline-item mb-0 bdrl1 pl15">Expensive</p>
