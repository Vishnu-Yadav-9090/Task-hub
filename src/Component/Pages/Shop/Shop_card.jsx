            ...
            <table className="table table-borderless">
              ...
              <tbody className="table_body">
                <tr>
                  <td className="pl30 ">
                    <div className="cart_list d-flex align-items-center">
                      <div className="cart-img">
                        <img src="images/shop/cart-1.png" alt="cart-1.png" />
                      </div>
                      <h5 className="mb-0"> Backpack School Bag</h5>
                    </div>
                  </td>
                  <td>
                    <div className="cart-price">$298</div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div className="cart-subtotal pl5">$1.298</div>
                  </td>
                  <td>
                ...
                <tr>
                  <td className="pl30 ">
                    <div className="cart_list d-flex align-items-center">
                      <div className="cart-img">
                        <img src="images/shop/cart-2.png" alt="cart-2.png" />
                      </div>
                      <h5 className="mb-0"> Backpack School Bag</h5>
                    </div>
                  </td>
                ...
                <tr>
                  <td className="pl30 ">
                    <div className="cart_list d-flex align-items-center">
                      <div className="cart-img">
                        <img src="images/shop/cart-3.png" alt="cart-3.png" />
                      </div>
                      <h5 className="mb-0"> Backpack School Bag</h5>
                    </div>
                  </td>
            ...
            <div className="coupon-form mt30 mb30-md">
              <div className="d-md-flex align-items-center justify-content-between">
                <div className="d-md-flex justify-content-between">
                  ...
                  />
                  <a
                    className="ud-btn btn-thm flex-shrink-0 ml20 ml0-sm"
                    href="#"
                  >
                    Apply Coupon
          ...
          <div className="shop-sidebar ms-lg-auto">
            <div className="order_sidebar_widget default-box-shadow1">
              ...
              <p className="text bdrb1 pb10">
                Subtotal <span className="float-end">$1.298</span>
              </p>
              <p className="text">
                Total <span className="float-end">$3.298</span>
              </p>
